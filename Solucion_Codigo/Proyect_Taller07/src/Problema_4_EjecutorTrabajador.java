...
public class Problema_4_EjecutorTrabajador {
    public static void main(String[] args) {
        ...
        // Instancias de trabajadores (ahora todos heredan de Trabajador)
...
abstract class Trabajador {
    ...
    // CORRECCIÓN: El jefe es un Trabajador, no específicamente un Jefe (evita dependencias circulares)
    ...
    // CORRECCIÓN: Acepta cualquier Trabajador como jefe
    public void setJefe(Trabajador j) { this.jefe = j; }
    public String getNombre() { return nombre; }
    public abstract double calcularSueldo();
}

// Ahora Jefe también es un Trabajador
...
/**
 * run:
N�mina de Luis: $1200.0
N�mina de Maria: $475.0
N�mina de Carlos: $500.0
